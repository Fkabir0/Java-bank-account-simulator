...
public class AccountDriver
{
	public static void main(String[] args)
	{
		...
		System.out.println ("Account Number "
			...
			" belonging to " + myCheckingAccount.getOwner() + ", this is a checking account");
		...
		System.out.println ("Account Number "
				...
				" belonging to " + yourAccount.getOwner() + ", this is a savings account");
		...
		System.out.println ("Account Number "
				...
				" belonging to " + secondAccount.getOwner() + ", this is a savings account");
		...
		System.out.println ("Account Number "
				...
				+ " belonging to "
				+ yourCheckingAccount.getOwner() + ", this is a checking account");
